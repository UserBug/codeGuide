...
* [Don't use JSX extension](https://github.com/UserBug/codeGuide/tree/v2/docs/files/donTUseJsxExtension.md)
* [Screaming Architecture](https://github.com/UserBug/codeGuide/tree/v2/docs/files/screamingArchitecture.md)  
